...
void mx_create_message_enter_area(void) {
    ...
    message_enter_area = gtk_box_new(GTK_ORIENTATION_HORIZONTAL, 0);
    gtk_widget_set_size_request(GTK_WIDGET(message_enter_area), CUR_WIDTH - CUR_WIDTH / 3 - 50, 30);
    gtk_fixed_put(GTK_FIXED(chat_area), message_enter_area, L_FIELD_WIDTH, CUR_HEIGHT - 54);
    gtk_widget_set_name(GTK_WIDGET(message_enter_area), "message_enter_area"); 

    add_image = gtk_event_box_new();
    gtk_widget_set_margin_top(GTK_WIDGET(add_image), 0);
    gtk_box_pack_start(GTK_BOX(message_enter_area), add_image, FALSE, FALSE, 8);
    ...
    gtk_box_pack_start(GTK_BOX(message_enter_area), entry_chat, TRUE, TRUE, 8);
    ...
    ban_image = gtk_event_box_new();
    gtk_box_pack_start(GTK_BOX(message_enter_area), ban_image, FALSE, FALSE, 8);
    ...
    tick_image = gtk_event_box_new();
    gtk_box_pack_start(GTK_BOX(message_enter_area), tick_image, FALSE, FALSE, 8);
    ...
    more_image = gtk_event_box_new();
    gtk_box_pack_start(GTK_BOX(message_enter_area), more_image, FALSE, FALSE, 8);
